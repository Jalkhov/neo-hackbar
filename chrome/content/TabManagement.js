...
HackBar.TabManagement.prototype = {
    ...
    destruct: function() {
        var container = gBrowser.tabContainer;
        var me = this;
        container.removeEventListener("TabSelect", function(event) {
            me.onTabSelect(event);
        }, false);
        container.removeEventListener("TabMove", function(event) {
            me.onTabMove(event);
        }, false);
        container.removeEventListener("TabClose", function(event) {
            me.onTabClose(event);
        }, false);
