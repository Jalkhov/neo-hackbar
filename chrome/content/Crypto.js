HackBar.Crypto = {
    ...
    getClearTextPassword: function (hash) {
        ...
        if (
            (hash == "md5" && this.isMD5(value)) ||
            (hash == "sha1" && this.isSHA1(value))
        ) {
            ...
            hackBar.setSelectedText(
                "To avoid sending private password to public databases only MD5 and SHA1 hashes will be submited"
            );
        }
    },
};
