...
if(!livehttpheaders.panel) livehttpheaders.panel={};

livehttpheaders.panel.SIDEBAR_CID      = Components.ID("{22117140-9c6e-11d3-aaf1-00805f8a4905}");
livehttpheaders.panel.SIDEBAR_CONTRACTID   = "@mozilla.org/sidebar;1";
livehttpheaders.panel.CONTAINER_CONTRACTID = "@mozilla.org/rdf/container;1";
livehttpheaders.panel.DIR_SERV_CONTRACTID  = "@mozilla.org/file/directory_service;1"
livehttpheaders.panel.STD_URL_CONTRACTID   = "@mozilla.org/network/standard-url;1"
livehttpheaders.panel.NETSEARCH_CONTRACTID = "@mozilla.org/rdf/datasource;1?name=internetsearch"

livehttpheaders.panel.addPanel = function(name, url, added, present) {
    var sidebar = new livehttpheaders.panel.mySidebar();
    sidebar.addPanel(url, name, added, present);
}

livehttpheaders.panel.mySidebar = function () {
...
livehttpheaders.panel.mySidebar.prototype.nc = "http://home.netscape.com/NC-rdf#";

/* decorate prototype to provide ``class'' methods and property accessors */
livehttpheaders.panel.mySidebar.prototype.addPanel = function (winurl, winname, msgadded, msgpresent) {
    var aTitle = winname;
    ...
    var panel_list = this.datasource.GetTarget(this.rdf.GetResource(this.resource), this.rdf.GetResource(livehttpheaders.panel.mySidebar.prototype.nc+"panel-list"), true);
    panel_list.QueryInterface(Components.interfaces.nsIRDFResource);

    var container = Components.classes[livehttpheaders.panel.CONTAINER_CONTRACTID].createInstance(Components.interfaces.nsIRDFContainer);
...
function getSidebarDatasourceURI(panels_file_id) {
    try {
        ...
        var directory_service = Components.classes[livehttpheaders.panel.DIR_SERV_CONTRACTID].getService();
